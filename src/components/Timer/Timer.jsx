...
const Timer = (props) => {
  ...
  useEffect(() => {
    ...
    if (props.nftNum === 1) {
      countDownDate = new Date('July 19, 2022 23:59:59').getTime()
    } else if (props.nftNum === 2) {
      countDownDate = new Date('July 21, 2022 16:33:44').getTime()
    } else if (props.nftNum === 3) {
      countDownDate = new Date('July 17, 2022 18:44:12').getTime()
    } else if (props.nftNum === 4) {
      countDownDate = new Date('July 25, 2022 22:54:51').getTime()
    }
