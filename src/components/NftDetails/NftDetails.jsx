    ...
    <div>
      <div className="h-60 w-60 ml-5 mr-5">
        <div className="flex justify-start items-center">
          ...
          <span className="mt-5 ml-2 font-semibold">{props.likes}</span>
        </div>
        <div className="flex">
          <div className="w-10 h-10 bg-gray-400 rounded-full mt-3 ml-3">
            <img
              ...
              src="https://html-tokenmart.netlify.app/light/assets/images/author/1.jpg"
              alt=""
            />
          </div>
        ...
        <div className="flex">
          ...
          <div className="w-3/5 flex flex-col justify-center items-center">
            <div className="mt-20 w-4/5">
              <NavLink to={`/exploreitem/${props?.id}`}>
                {" "}
                <div className="w-full h-10 border-2 rounded-lg border-blue-400 bg-gradient-to-r hover:border-white hover:from-purple-500 hover:to-indigo-500 text-blue-400 hover:text-white">
                  <h1 className="" style={{ marginTop: "4px" }}>
                    Place a bid
                  </h1>
                </div>
              </NavLink>
