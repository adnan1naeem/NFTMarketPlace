...
const Navbar = ({ screen }) => {
  ...
  return (
    <div
      className={`lg:flex lg:justify-center w-full ${
        scroll ? "bg-green-200" : "bg-transparent"
      }`}
    >
      <nav
        className={` 
         px-5
     flex items-center justify-between lg:justify-center  flex-wrap py-5 md:py-2 z-40 lg:fixed text-white w-full lg:h-20 ${
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className={`w-36 h-40 bg-white shadow shadow-4xl absolute z-20 mt-32 ${
