    ...
    <div className="flex flex-col items-center">
      <div className="" style={{ maxWidth: "1700px" }}>
        <div className="flex items-center justify-between 2xl:justify-center w-full">
          <h1 className="text-4xl text-left 2xl:text-center font-bold mt-10 sm:ml-20 xl:ml-0">
            Live Auctions
          </h1>
          <NavLink to="/explore">
            <button className="mt-10 bg-blue-300 rounded-lg hover:bg-blue-400 px-3 py-2 sm:mr-20 xl:mr-0 hidden sm:flex 2xl:hidden ">
        ...
        <div className="flex items-center justify-center mb-10">
          <div className="flex flex-wrap items-center justify-center">
            {nftAuctionData.map((i) => {
              return (
                <div
                  className=" pb-5 mt-5 hover:shadow hover:shadow-lg"
                ...
                >
                  <div>
                    ...
                    <div
                      className={`w-44 h-16 rounded-lg border-blue-400 text-blue-400 absolute -mt-24 ml-20 bg-gradient-to-r from-indigo-500 to-purple-500 ${
